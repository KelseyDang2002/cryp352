...
def leftCircularShiftKey(key, shiftAmount):
	...
	return rotateStringLeft[:shiftAmount] + rotateStringLeft[shiftAmount:]
	
# Original block
block = "0101110010100101101011000111000101011001101111001000011101110001"

result = doTable(__ip, block)
print("Block: " + block)
print("\nResult: " + result)
...
lh = rotateStringLeft(pc1Out[:28], 1)
rh = rotateStringLeft(pc1Out[28:], 1)

lcsOut = lh + rh
pc2Out = doTable(__pc2, lcsOut)

print(originalKey, " ", len(originalKey))
print(pc1Out, " ", len(pc1Out))
...
round1 = LCS by 1 bit
0111111000001011111101010010 1101100001110110110001100110

1111110000010111111010100100 1011000011101101100011001101

Result = 11111100000101111110101001001011000011101101100011001101
